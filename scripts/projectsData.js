const projects = [ 
  {
    name: "Création la page d'accueil d'une agence de voyage avec HTML & CSS",
    description: "L'objectif de ce projet est de développer un site Internet qui permet aux usagers de trouver des hébergements et des activités dans la ville de leur choix.\nL'interface est créée avec du code HTML et CSS.",
    image: "./assets/booki.JPG",
    imagewebsite: "./assets/booki-entirepage.png",
  },
  {
    name: "Amélioration de l'interface d'un site mobile avec des animations CSS",
    description: "La mission est de développer un site “mobile first” qui répertorie les menus de restaurants gastronomiques. Le site doit être responsive (mobile, tablette et desktop) et en “mobile first”. \nCe projet met en avant la maîtrise de l'implémentation des animations CSS et l'utilisation de SASS.",
    image: "./assets/ohmyfood.JPG",
    imagewebsite: "./assets/ohmyfood-entirepage.png",
    website: "https://marinevnt.github.io/Ohmyfood---Openclassrooms/",
    gitlink: "https://github.com/marinevnt/Ohmyfood---Openclassrooms.git"
  },
  {
  ...
  },
  {
    ...
    gitlink: "https://github.com/marinevnt/Nina-Carducci--OpenClassrooms.git"
  },
  {
    name: "Débogage du site d'une agence d'événementiel",
    description: "L'objectif de ce projet est de corriger les différents bugs du site internet d'une agence d'événementiel. \nOutre le débogage, les objectifs sont également d'améliorer le site, de s'entraîner à la rédaction de tests unitaires, ainsi que rédiger un cahier de recette qui contient les différents scénarios vérifiant que le site fonctionne correctement. \nLe site utilise React et SASS.",
    image: "./assets/77events.JPG",
    imagewebsite: "./assets/77events-entirepage.png",
    gitlink: "https://github.com/marinevnt/77events--Openclassrooms.git"
  },
  {
